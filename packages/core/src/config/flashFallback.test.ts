...
import { DEFAULT_MODEL, DEFAULT_FLASH_MODEL } from './models.js';
...
describe('Flash Model Fallback Configuration', () => {
  ...
  describe('setModel', () => {
    it('should update the model and mark as switched during session', () => {
      ...
      config.setModel(DEFAULT_FLASH_MODEL);

      expect(config.getModel()).toBe(DEFAULT_FLASH_MODEL);
    ...
    it('should only mark as switched if contentGeneratorConfig exists', () => {
      ...
      newConfig.setModel(DEFAULT_FLASH_MODEL);
