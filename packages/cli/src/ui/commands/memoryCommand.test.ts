...
import { getErrorMessage } from '@samus-code/samus-code-core';

vi.mock('@samus-code/samus-code-core', async (importOriginal) => {
  const original =
    await importOriginal<typeof import('@samus-code/samus-code-core')>();
  return {
    ...original,
